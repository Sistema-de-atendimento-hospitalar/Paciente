...
public class ApiExceptionHandle extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		Wrapper wrapper = createWrapper(status, ProblemType.MENSAGEM_INCOMPREENSIVEL, detail, request);
	...
	private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex, HttpHeaders headers,
		...
		Wrapper wrapper = createWrapper(status, problemType, detail, request);
	...
	public ResponseEntity<Object> handleNotFound(NotFoundException ex, WebRequest request) {
		...
		Wrapper wrapper = createWrapper(status, ProblemType.ENTIDADE_NAO_ENONTRADA, ex.getMessage(), request);
		return this.handleExceptionInternal(ex, wrapper, new HttpHeaders(), status, request);
	}
	...
	public ResponseEntity<Object> handleOtherException(Exception ex, WebRequest request) {
		...
		Wrapper wrapper = createWrapper(status, ProblemType.ERRO_DE_SISTEMA, description, request);
		return this.handleExceptionInternal(ex, wrapper, new HttpHeaders(), status, request);
	}
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		ex.printStackTrace();
		Wrapper wrapper = createWrapper(status, ProblemType.RECURSO_NAO_ENCONTRADO, description, request);
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		Wrapper wrapper = createWrapper(status, ProblemType.DADOS_INVALIDOS, request, errors, description);
		return this.handleExceptionInternal(ex, wrapper, headers, status, request);
	}
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex,
		...
		Wrapper problem = createWrapper(status, problemType, detail, request);
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		if (body == null) {
			body = createWrapper(status.getReasonPhrase(), status.value(), INTERNAL_ERROR, request);
	...
	private Wrapper createWrapper(HttpStatus status, ProblemType problemType, String detail, WebRequest request) {
		...
		wrapper.setPath(((ServletWebRequest) request).getRequest().getRequestURI());

		return wrapper;
	}

	private Wrapper createWrapper(String title, Integer status, String message, WebRequest request) {
		Wrapper wrapper = new Wrapper();
		wrapper.setDate(LocalDateTime.now());
	...
	private Wrapper createWrapper(HttpStatus status, ProblemType problemType, WebRequest request,
			Map<String, String> errors, String description) {
		Wrapper wrapper = new Wrapper();
		wrapper.setDate(LocalDateTime.now());
		wrapper.setStatus(status.value());
		wrapper.setTitle(problemType.getTitle());
		wrapper.setErrors(errors);
		wrapper.setDetail(description);
		wrapper.setPath(((ServletWebRequest) request).getRequest().getRequestURI());
